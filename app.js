...
const RESULTS = {
  T1: {
    mode: "公司一抽象，你体内的“纠偏程序”会立刻开机。别人还在适应混乱，你已经开始找定义、边界、责任、标准和错别字。你真正受不了的不是忙，而是所有人明明看见问题，却一起装成没看见。",
    guard: "你守护的是“正确感”。只要事情没有被讲清楚、做扎实、对齐标准，你就会感觉这个世界正在往歪里长。",
  ...
  T2: {
    ...
    guard: "你守护的是“被需要感”。当别人需要你，你会觉得自己有位置；当没人需要你，你反而会有一点空。",
  ...
  T3: {
    ...
    guard: "你守护的是“价值感”。你需要看见成果、被确认、被证明，否则会怀疑自己是不是白燃了。",
  ...
  T4: {
    ...
    guard: "你守护的是“独特感”。你害怕自己被做成普通零件，更害怕认真表达后没人懂。",
  ...
  T5: {
    ...
    guard: "你守护的是“边界感”。你的时间、注意力、脑子和私人空间不能被随便闯入。",
  ...
  T6: {
    ...
    guard: "你守护的是“安全感”。你需要知道坑在哪里、谁可信、出了事怎么退、有没有备用路线。",
  ...
  T7: {
    ...
    guard: "你守护的是“自由感”。你怕被困住、被规定死、被无聊钉在一个没有选择的格子里。",
  ...
  T8: {
    ...
    guard: "你守护的是“主权感”。你怕被操控、被糊弄、被迫接受一个软弱又不公平的局面。",
  ...
  T9: {
    ...
    guard: "你守护的是“和平感”。你害怕冲突升级、关系断裂，也害怕自己被迫站到某一边。",
...
const ASSET_VERSION = "20260615-precision-v1";
